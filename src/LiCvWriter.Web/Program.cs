...
builder.TryEnableLiCvWriterStaticWebAssets();
...
app.RegisterLiCvWriterHostLifetimeDiagnostics(lifetimeLogger);
...
app.MapLiCvWriterExportedFileEndpoints();

app.MapLiCvWriterBenchmarkEndpoints();

app.MapLiCvWriterLlmOperationEndpoints();
