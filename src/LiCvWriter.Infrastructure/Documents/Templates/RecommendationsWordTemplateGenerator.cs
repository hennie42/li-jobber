...
/// <summary>
/// Generates the Word template used for standalone recommendation documents.
/// </summary>
public static class RecommendationsWordTemplateGenerator
{
    private const string AccentColorHex = "8F3F2D";
    private const string PrimaryFont = "Aptos";
    private const string PrimaryFontFallback = "Calibri";

    public static readonly IReadOnlyList<RecommendationsTemplateSection> Sections =
    [
        ...
        new("DocumentIntro", "Recommendation Brief", "[Brief recommendation context]"),
        new("RecommendationsBody", "Recommendations", "[Recommendation quotes with attribution]")
    ];
    ...
    private static SdtBlock CreateTaggedContentControl(RecommendationsTemplateSection section)
        => new(
            new SdtProperties(
...
/// <summary>
/// Describes a recommendation document section exposed as a named content control.
/// </summary>
public sealed record RecommendationsTemplateSection(string Tag, string Title, string Placeholder);
