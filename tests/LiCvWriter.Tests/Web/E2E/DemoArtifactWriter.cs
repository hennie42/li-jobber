...
public sealed class DemoArtifactWriter
{
    ...
    private void WriteMarkdown()
    {
        ...
        markdown.Add("6. It returns to the overview, selects three job sets, clicks Start selected, and holds on live batch status, Reasoning Monitor, and Activity Monitor updates.");
        markdown.Add(string.Empty);
